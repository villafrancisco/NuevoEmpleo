...
INSERT INTO `administradores` (`idadmin`, `idusuario`, `email`, `contrasena`, `nombre`, `apellidos`) VALUES
	(10, 25, 'administrador@administrador.com', _binary 0x243279243130246C4D353670364952477747784554667A7532796B2E4F3053655A627A522F464E4A665476564D784C55306F72357947506552584253, 'administrador', 'administrador'),
...
INSERT INTO `empresas` (`idempresa`, `idusuario`, `email`, `contrasena`, `nombre`, `direccion`, `nif`) VALUES
...
-- Volcando datos para la tabla nuevoempleo.titulados: ~2 rows (aproximadamente)
