...
INSERT INTO `administradores` (`idadmin`, `idusuario`, `email`, `contrasena`, `nombre`, `apellidos`) VALUES
	(1, 11, 'administrador@administrador.com', '$2y$10$aCRz4P.r.VnpuIHUq1.Yr.4zcUeTt3JKTDRcXJzx84RftLqlgV21O', 'administrador nombre', 'administrador apellidos');
...
-- Volcando datos para la tabla nuevoempleo.empleos: ~8 rows (aproximadamente)
DELETE FROM `empleos`;
...
-- Volcando datos para la tabla nuevoempleo.empresas: ~4 rows (aproximadamente)
...
INSERT INTO `empresas` (`idempresa`, `idusuario`, `email`, `contrasena`, `nombre`, `telefono`, `direccion`, `logo`) VALUES
	...
	(5, 21, 'empresa4@empresa.com', '$2y$10$MENW7suCoLyqR.5pSBBvMOxp44q8KDItjqa/N5Ar8VUjlRISJ3UP2', 'Farmalab', '65415987', 'avenida esperanza', 'no-imagen.svg');
...
-- Volcando datos para la tabla nuevoempleo.inscripciones: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla nuevoempleo.titulados: ~14 rows (aproximadamente)
...
INSERT INTO `titulados` (`idtitulado`, `idusuario`, `idtitulo`, `email`, `contrasena`, `nombre`, `apellidos`, `direccion`, `dni`, `telefono`, `curriculum`, `foto`) VALUES
	(4, 7, 97, 'titulado1@titulado.com', '$2y$10$YN8nx8ssyI9CvOW9xMDGX.fA19W.WSr3Qvq3GXc7EhxG91qwNV.z2', 'Juan ', 'Perez García', 'calle magallanes', '72135489m', '666999333', 'titulados/7/6abd64_cv.pdf', 'titulados/7/0fa1db_2702378-middle.png'),
	(5, 8, 100, 'titulado2@titulado.com', '$2y$10$iDRg03wm1hsYrzLPEVUW6eJ5Fb31aSWTb0J4VU16e/g3di/Mk62AC', 'Maria', 'González Perez', 'calle peredo', '72147852m', '666555999', 'titulados/8/c578a2_cv.pdf', 'titulados/8/c578a2_logo.ico'),
	(6, 9, 97, 'titulado3@titulado.com', '$2y$10$mUisYrIbXS7K1wx7OBC66.lPRep8LcD8L5.9fY71yLalv7ldXe1Kq', 'Miguel', 'Hernandez', 'calle ramiro', '741235698m', '987456321', 'titulados/9/255b5d_cv.pdf', 'no-imagen.svg'),
	(7, 10, 62, 'titulado4@titulado.com', '$2y$10$ftfxQHsH50CWUJtJRpGYZOQwPDxbnTUHstYV8DycW7Gd8Ex2wnWPi', 'Antonio', 'Saiz', 'calle antonio saiz', '72135480m', '659879452', 'titulados/10/27fd42_cv.pdf', 'no-imagen.svg'),
	(8, 12, 67, 'titulado5@titulado.com', '$2y$10$aRgk/G1PMLUVTWivjX9UUe.XukEyQsC4yyM/AY53qpVmYHmSJl.O6', 'Marissa', 'Cortavitarte', 'calle peredo', '789456123m', '456987456', 'titulados/12/d2f02f_cv.pdf', 'no-imagen.svg'),
	(9, 13, 114, 'titulado6@titulado.com', '$2y$10$ilqLI.HFnAuuUmkonu2da.k3f3wq8sCzdDX.ZXmHAO/mnJ6vAGkvC', 'Andrés', 'Arana', 'calle perez', '78951236m', '666333666', 'titulados/13/379e30_cv.pdf', 'titulados/13/f01150_no-perfil.png'),
	(10, 15, 94, 'titulado7@titulado.com', '$2y$10$oRFr/Kv/oONhPxJu6tjzbuc1sVNyIgAx6SfoCdUYGgN6pHmv.GPKK', 'Alejandro', 'Lopez', 'calle heminio 3', '72135480r', '666555999', 'titulados/15/02342e_cv.pdf', 'no-imagen.svg'),
	(11, 16, 102, 'titulado8@titulado.com', '$2y$10$g4jfgkEw77TDbn6Nb31vo.tIsDoDKlme8PIzpj1h1y4ZRXjCkPkv2', 'Natalia', 'Arozamena', 'avenida constitución', '74123658j', '666555888', 'titulados/16/655249_cv.pdf', 'no-imagen.svg'),
	(12, 17, 67, 'titulado9@titulado.com', '$2y$10$z64kCOcDbXk40jrt.X5s4ulHDUoX0zJtoOJacxK2CGfec.RuJzxU6', 'Sonia', 'Martinez', 'avenida españa', '74123658n', '789654123', 'titulados/17/b32511_cv.pdf', 'no-imagen.svg'),
	(13, 18, 97, 'titulado10@titulado.com', '$2y$10$i2QdZ6X2PzxvKXOn/aaLoOmcaZngqcAKS4diKXxqeJps1qbkeSmSC', 'Patricia', 'Jimenez', 'avenida cantabria', '78965895l', '666555444', 'titulados/18/dc4599_cv.pdf', 'no-imagen.svg'),
	(14, 22, 56, 'titulado11@titulado.com', '$2y$10$uURzrinAe0KrxE/kZFqcb.GcSWiEVQ8036NrcGEGkXfpJLBG9ah3m', 'Sandra', 'Ibañez', 'calle perico 12', '7214789544f', '666555444', 'titulados/22/e87007_cv.pdf', 'no-imagen.svg'),
	(15, 23, NULL, 'titulado12@titulado.com', '$2y$10$Ix/XDmnf314EF8rij/nWOec51tIvCox99qzl2CO0jAEPSXd/e/XyW', NULL, NULL, NULL, NULL, NULL, NULL, 'no-imagen.svg'),
	(16, 24, 64, 'titulado14@titulado.com', '$2y$10$P7Cx2GLTMc/JfeJLPD3eh.uP1jCsoZFeXnNQnLxhwMQaQk39hevYK', 'Enrique', 'Cerezo', 'marbella', '72147852l', '659745896', 'titulados/24/b5c29d_cv.pdf', 'titulados/24/42c969_no-perfil.png'),
	(17, 25, NULL, 'titulado15@titulado.com', '$2y$10$yFSsV5f/uaPxcFb4OG9N6uslnd6Eukx21pX4WTsvvj87oBHZszCau', NULL, NULL, NULL, NULL, NULL, NULL, 'no-perfil.png');
...
-- Volcando datos para la tabla nuevoempleo.usuarios: ~18 rows (aproximadamente)
