...
INSERT INTO `administradores` (`idadmin`, `idusuario`, `email`, `contrasena`, `nombre`, `apellidos`) VALUES
	(2, 5, 'okik1981@hotmail.com', _binary , 'Francisco', 'Gonzalez');
...
-- Volcando datos para la tabla nuevoempleo.titulados: ~1 rows (aproximadamente)
...
INSERT INTO `titulados` (`idtitulado`, `idusuario`, `email`, `contrasena`, `nombre`, `apellidos`, `direccion`, `dni`, `telefono`, `curriculum`, `foto`, `fecha_registro`) VALUES
	(6, 10, 'okik1981@hotmail.comm', _binary , '', '', '', '', '', '', '', '0000-00-00 00:00:00'),
	(10, 15, 'fvillag011@educantabria.es', _binary , '', '', '', '', '', '', '', '0000-00-00 00:00:00');
...
-- Volcando datos para la tabla nuevoempleo.usuarios: ~2 rows (aproximadamente)
